        ...
        <div className="bg-white flex flex-col">
            <div className="flex flex-row justify-between items-start">
                <div className="flex flex-row gap-12 w-2/3 items-start">
                    ...
                    <img alt="" src="https://file.rendit.io/n/nt9d9NywRFAuzVvO1IQz.svg" className="mt-16" />
                </div>
                <div className="self-end relative flex flex-col w-56 shrink-0 items-start">
                    <img alt="" src="https://file.rendit.io/n/ixV6arnHWTPCK4YAtrNa.svg" className="w-40 h-40 absolute top-20 left-16" />
                    <img alt="" src="https://file.rendit.io/n/5kEVvlKlCwjKEctJMJHW.svg" className="w-32 h-[286px] absolute top-24 left-24" />
                    <img alt="" src="https://file.rendit.io/n/SE9KBe05w8jCFurFlTTW.svg" className="relative" />
                </div>
            </div>
        </div>
    )
